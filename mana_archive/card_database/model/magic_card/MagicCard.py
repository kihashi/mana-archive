...
class MagicCard(Base):
    ...
    colors = relationship("Color", secondary="card_color_link")
    supertypes = relationship("Supertype", secondary="card_supertype_link")
    card_types = relationship("CardType", secondary="card_card_type_link")
    subtypes = relationship("Subtype", secondary="card_subtype_link")
